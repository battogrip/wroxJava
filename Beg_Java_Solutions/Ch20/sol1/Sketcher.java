...
// Implements a toolbar button that displays a dialog to select the element color
/*
 ...
 - added a toolbar button in the constructor using a ColorDialogAction class
*/
