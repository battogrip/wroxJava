...
public abstract class Element {
  ...
  public void scale(double scaleX, double scaleY) {
    assert scaleX>0 && scaleY>0 : "Zero scale factor";
    xScale *= scaleX;
    yScale *= scaleY;
  }
  ...
  protected void draw(Graphics2D g2D, Shape element) {
    ...
    g2D.scale(xScale, yScale);                          // Scale the element
...
//    g2D.rotate(angle);                                // Rotate about position
  ...
  protected java.awt.Rectangle getBounds(java.awt.Rectangle bounds) { 
    ...
    at.scale(xScale, yScale);                       // Apply scaling
    at.rotate(angle);
  ...
  protected double xScale = 1.0;                 // Element scale in x
  protected double yScale = 1.0;                 // Element scale in y
