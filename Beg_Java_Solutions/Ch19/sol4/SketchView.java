  ...
  class MouseHandler extends MouseInputAdapter {
    ...
    private Element createElement(Point start, Point end) {
      switch(theApp.getWindow().getElementType()) {
        ...
        case RECTANGLE:
          return new Element.Rectangle(start, end, theApp.getWindow().getElementColor(), theApp.getWindow().isFillOn());

        case CIRCLE:
          return new Element.Circle(start, end, theApp.getWindow().getElementColor(), theApp.getWindow().isFillOn());

        case CURVE:
          return new Element.Curve(start, end, theApp.getWindow().getElementColor(), theApp.getWindow().isFillOn());

        case ELLIPSE:
          return new Element.Ellipse(start, end, theApp.getWindow().getElementColor(), theApp.getWindow().isFillOn());
