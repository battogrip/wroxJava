...
public class SketchFrame extends JFrame {
  ...
  public SketchFrame(String title, Sketcher theApp) {
    ...
    // Add the fill button to the toolbar 
    fillButton = addToolBarButton(new FillAction()); 
    fillButton.setSelectedIcon(new ImageIcon("Images/fill.gif"));     // Set the icon for selected state
  ...
  // Method to return whether fill is on or off
  ...
  // Inner class defining the action for the fill button
  class FillAction extends AbstractAction {    
    // Constructor
    FillAction() {
      super("Fill");
      String iconFileName = "Images/nofill.gif";     // Default is no fill
      if(new File(iconFileName).exists()) {
        putValue(SMALL_ICON, new ImageIcon(iconFileName));
      }
      putValue(SHORT_DESCRIPTION, "Fill enable/disable");
    }
    
    // Event handler
    public void actionPerformed(ActionEvent e) {
      fillButton.setSelected(!fillButton.isSelected());
    }
  }
  ...
  private JButton fillButton = null;                   // Toolbar button for fill operation
  ...
  private TypeAction lineAction, rectangleAction, circleAction, curveAction, ellipseAction;
