...
/*
  ...
  segments. This boils down to determining the control points, given the set of points
...
public class CurveApplet extends JApplet {
  ...
  Vector<Marker> pointMarkers = new Vector<Marker>();  // Vector of Marker objects
