...
import java.awt.print.Paper;         // Used by commented out code
...
//        printJob.setPageable(theApp.getView());
        ...
        // Create a Book object containing the pages for the print job
        Book sketchBook = new Book();
        PageFormat pageFormat = PrinterJob.getPrinterJob().defaultPage();

        // Uncomment this code to increase the sizes of the margins in the Paper object
/*        Paper paper = pageFormat.getPaper();
        ...
        leftMargin *= 2;                                   // Double the left margin...
        rightMargin *= 2;                                  // ...and the right...
        topMargin *= 2;                                    // ...and the top...
        bottomMargin *= 2;                                 // ...and the bottom
...
*/
        ...
        // Append four pages painted by the view object
        sketchBook.append(theApp.getView(), pageFormat, 4); 
