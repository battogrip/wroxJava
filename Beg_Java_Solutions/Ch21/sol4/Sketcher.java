...
// Use a book object to draw a sketch spread over four pages when it is printed.
/*
  The additional code to do this is in the actionPerformed() method in the FileAction
  inner class to the SkecthFrame class. The print() and getNumberOfPages() methods
  in SketchView are as in the solution to the previous exercise.
