...
public class SketchFrame extends JFrame {
  ...
  public SketchFrame(String title) {
    ...
    exitAction = new FileAction("Exit", KeyStroke.getKeyStroke('X',CTRL_DOWN_MASK), "Exit");      // *ADDED*
    ...
    fileMenu.addSeparator();                     // *Added*
    addMenuItem(fileMenu, exitAction);           // *Added*
    ...
    addMenuItem(colorMenu, redAction = new ColorAction("Red", RED, "Draw in red"));
    addMenuItem(colorMenu, yellowAction = new ColorAction("Yellow", YELLOW, "Draw in yellow"));
    addMenuItem(colorMenu, greenAction = new ColorAction("Green", GREEN, "Draw in green"));
    addMenuItem(colorMenu, blueAction = new ColorAction("Blue", BLUE, "Draw in blue"));
    ...
    toolBar.addSeparator();                      // *ADDED*
    addToolBarButton(exitAction);                // *ADDED*
  ...
  // Method to add an action to a menu
  ...
  private FileAction exitAction;                          // *ADDED*
