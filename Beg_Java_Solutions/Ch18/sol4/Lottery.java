...
/*
  What was the MouseHandler class is now an inner class to Lottery with the name
  SelectionHandler. An object of this inner class type now listens for selection
  button events.
  The applet now consists of a single source file. If you look at the .class files
  produced by the compiler you'll see you still get five files. 
*/
...
public class Lottery extends JApplet {
  ...
  public void createGUI() {
    ...
    SelectionHandler handler = new SelectionHandler();        // Create the listener
    for(int i = 0; i<numberCount; i++) {
     luckyNumbers[i] = new Selection(choices[i]);
     luckyNumbers[i].addMouseListener(handler);
  ...
  // Inner class to handle selection button events.
