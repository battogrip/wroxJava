...
/*
   This is very easy. You just restore the previously redundant MouseHandler class and use an
   object of  this type to listen for events on each control button.
   Alternatively you could add MouseHandler as another inner class to Lottery.
*/
