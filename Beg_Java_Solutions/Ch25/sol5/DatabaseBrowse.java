...
/*
  This is a development of Solution 4 where the actionPerformed() method additionally displays 
  a JOptionPane to allow a WHERE clause to be entered before assembling the SQL query string.
  
  You could also just create a JTextField where the WHERE clause condition can be entered
  and assemble the query in the same way.
